  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/60 p-4 flex items-center justify-center">
      <div className="w-full max-w-xl rounded-2xl bg-white shadow-2xl overflow-hidden">
        {popup.cover_image ? <div className="relative h-52 w-full"><Image src={popup.cover_image} alt={popup.title} fill className="object-cover" sizes="(max-width: 768px) 100vw, 640px" /></div> : null}
        <div className="p-6">
